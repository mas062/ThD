...
% \begin{figure}
% \begin{tabular}{cc}
% \includegraphics[width=0.45 \linewidth]{./figurer/fineSat_Perspective_actual}&
% \includegraphics[width=0.45 \linewidth]{./figurer/fineSat_Perspective_uniform}
% \\(a)&(b)
% \end{tabular}
% \caption{bla bla bla}
% \label{fig:faciesAll}
...
\begin{figure}
\begin{tabular}{ccc}
\includegraphics[width=0.3 \linewidth]{./figurer/fineSat_Perspective_actual}&
\includegraphics[width=0.3 \linewidth]{./figurer/fineSat_Perspective_uniform}&
\includegraphics[width=0.3 \linewidth]{./figurer/kxh_all}\\(a)&(b)&(c)
\end{tabular}
\caption{bla bla bla}
\label{fig:finAll}
\end{figure}
...
\includegraphics[width=0.3 \linewidth]{./figurer/facies_3}\\(a)&(b)&(c)\\
\includegraphics[width=0.3 \linewidth]{./figurer/facies_4}&
\includegraphics[width=0.3 \linewidth]{./figurer/facies_5}&
\includegraphics[width=0.3 \linewidth]{./figurer/facies_6}\\(d)&(e)&(f)
\end{tabular}
\caption{bla bla bla}
\label{fig:facies}
\end{figure}
